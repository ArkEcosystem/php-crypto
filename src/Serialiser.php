...
{
    /**
     * The transaction serialisers.
     *
     * @var array
     */
    private $serialisers = [
        Serialisers\Transfer::class,
        Serialisers\SecondSignatureRegistration::class,
        Serialisers\DelegateRegistration::class,
        Serialisers\Vote::class,
        Serialisers\MultiSignatureRegistration::class,
        Serialisers\IPFS::class,
        Serialisers\TimelockTransfer::class,
        Serialisers\MultiPayment::class,
        Serialisers\DelegateResignation::class,
    ];
    ...
    {
        $serialiser = $this->serialisers[$this->transaction->type];

        return (new $serialiser($this->transaction, $bytes))->serialise();
    }
