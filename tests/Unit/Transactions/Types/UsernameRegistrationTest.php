...
beforeEach(function () {
    $this->fixture = $this->getTransactionFixture('evm_call', 'username-registration');

    $this->subject = new UsernameRegistration($this->fixture['data']);
});
...
it('should return empty payload if no username', function () {
    unset($this->subject->data['username']);
