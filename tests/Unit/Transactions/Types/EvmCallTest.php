...
beforeEach(function () {
    $this->fixture = $this->getTransactionFixture('evm_call', 'evm-sign');

    $this->subject = new EvmCall($this->fixture['data']);
});
...
it('should get the payload', function () {
    expect($this->subject->getPayload())->toBe($this->fixture['data']['data']);
});
