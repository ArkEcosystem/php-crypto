...
// Test vectors matching the TypeScript SDK ProofOfPossession.test.ts exactly
...
const POP_PASSPHRASE = 'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about';

// Pinned hex from the TypeScript SDK noble-curves reference (ProofOfPossession.test.ts)
...
it('throws on the zero secret key', function () {
    // sk = 0 means pk = identity → invalid per BLS spec
